...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    try {
      ...
      context.installBundle("file:target/bundle/org.foo.hello.jar");
      Bundle client = context.installBundle("file:target/bundle/org.foo.hello.modularity.jar");
      m_framework.start();
      client.loadClass("org.foo.hello.modularity.Client").newInstance();
      m_framework.stop();
    } catch (Exception ex) {
