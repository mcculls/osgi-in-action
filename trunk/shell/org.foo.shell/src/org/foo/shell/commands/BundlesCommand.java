...
public class BundlesCommand extends BasicCommand {
  public void exec(String args, PrintStream out, PrintStream err) throws Exception {
    ...
    for (Bundle bundle : bundles) {
      printBundle(bundle.getBundleId(), getStateString(bundle.getState()), (String) bundle.getHeaders().get(
        Constants.BUNDLE_NAME), (String) bundle.getHeaders().get(
            Constants.BUNDLE_VERSION), bundle.getLocation(), bundle.getSymbolicName(), out);
    }
  }
  ...
  private void printBundle(long id, String state, String name, String version, String location, String symbolicName, PrintStream out) {
    out.print("[");
