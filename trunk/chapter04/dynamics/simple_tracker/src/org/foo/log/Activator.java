 ...
 * To run this example:
 * 
 *   ./chapter04/dynamics/PICK_EXAMPLE 7
 * 
 * Expected result:
 * 
 *   <3> thread="main", bundle=6 : logging ON
 *   <3> thread="LogService Tester", bundle=6 : ping
 *   ...
 * 
 * If you stop the simple LogService with "stop 1" you should see the following:
 * 
 *   <3> thread="Thread-1", bundle=6 : logging OFF
 *   <--> thread="LogService Tester", bundle=6 : LogService has gone
 * 
 ...
 * 
 *   <5> thread="Thread-1", bundle=6 : logging ON
 *   <5> thread="LogService Tester", bundle=6 : ping
 *   ...
 * 
